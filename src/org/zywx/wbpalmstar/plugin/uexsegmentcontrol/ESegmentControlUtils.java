...
public class ESegmentControlUtils {
	...
	public final static String SEGMENTCONTROL_PARAMS_JSON_KEY_ON_RESULT_INDEX = "index";
    public final static String SEGMENTCONTROL_PARAMS_JSON_KEY_ON_RESULT_NAME = "name";
    public final static String SEGMENTCONTROL_PARAMS_JSON_KEY_ON_RESULT_SHOWS = "shows";
